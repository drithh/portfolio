  ...
  return (
    <section id="about" className="flex flex-col gap-6 lg:mt-8">
      <div className="flex flex-col gap-2 text-justify">
        <div className="mb-3 text-xl text-secondary-foreground text-opacity-50 md:text-2xl">
          Ohh you found me?. Howdy!
        </div>
        <div>
          My name is <span className="font-semibold">Adriel Alfeus Hutabarat</span>,
          I&apos;m a Web Developer based in Bekasi, Indonesia. I graduated from
          Sebelas Maret University with a Bachelor of Computer Science.
        </div>
        <div>
